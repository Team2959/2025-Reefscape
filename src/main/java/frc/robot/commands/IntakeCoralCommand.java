...
public class IntakeCoralCommand extends Command {
  ...
  public void initialize() {
    m_coralDeliverySubsystem.setRightCoralControlVelocity(CoralControlTargetSpeeds.Feed);
    m_coralDeliverySubsystem.setLeftCoralControlVelocity(CoralControlTargetSpeeds.Feed);
  }
