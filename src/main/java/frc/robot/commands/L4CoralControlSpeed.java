...
public class L4CoralControlSpeed extends Command {
  /** Creates a new L4CoralControlSpeed. */
  private CoralDeliverySubsystem m_coralDeliverySubsystem;
  public L4CoralControlSpeed(CoralDeliverySubsystem coralDeliverySubsystem) {
